...
const ExplorarCiudades = () => {
    ...
    const irACiudades = () => {
        ...
        navigate(`/departamentos/${currentDepartamento.id}/ciudades`);
    };
                ...
                <section className="explorar-prov-content">
                    <div className="explorar-prov-left">
                        ...
                        <div className="explorar-prov-location">
                            <span></span>
                            <p>Explorar ciudades por departamento</p>
                        </div>

                        <h1>{currentDepartamento.nombre}</h1>

                        <p className="explorar-prov-description">
                            Selecciona un departamento del Perú para consultar sus ciudades,
                            actividad principal, atractivo turístico, clima y descripción cultural.
                        </p>
...
export default ExplorarCiudades;