...
import { getCiudadesByProvincia } from '../services/ciudadService';
...
const CiudadesProvincia = () => {
    ...
    const getCiudadImage = (ciudad) => {
        ...
        return image || getProvinciaImage(provincia);
    };
    ...
    const cargarDatos = async () => {
        try {
            ...
            const [provinciaData, ciudadesData] = await Promise.all([
                getProvinciaById(id),
                getCiudadesByProvincia(id, 1, 100)
            ]);
            ...
            setError(err.response?.data?.error || 'Error al cargar ciudades de la provincia');
        } finally {
            setLoading(false);
        }
    };
        ...
        return (
            <div className="distritos-showcase-page">
                ...
                <main className="distritos-state">
                    ...
                    <p>
                        Aún no se han registrado ciudades para la provincia de{' '}
                ...
                <section className="distritos-showcase-content">
                    <div className="distritos-left">
                        <div className="distritos-top-actions">
                            ...
                            {isAdmin && (
                                <button
                                    ...
                                    onClick={() => navigate(`/gestionar-ciudades?provincia_id=${id}`)}
                                >
                                    Gestionar ciudades
                                </button>
                            )}
                        ...
                        <div className="distritos-location">
                            <span></span>
                            <p>
                                Ciudad de {provincia?.nombre || 'Provincia'}
                            </p>
                        </div>
                        ...
                        <div className="distritos-details">
                            <div>
                                <span>Distrito</span>
                                <strong>{currentCiudad.distrito_nombre || 'No registrado'}</strong>
                            </div>
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <div className="distrito-preview-content">
                                            <span></span>
                                            <small>{ciudad.distrito_nombre || 'Distrito'}</small>
                                            <strong>{ciudad.nombre}</strong>
                                            <p>{ciudad.tipo_ciudad || 'Ciudad'}</p>
                                        </div>
                                    </button>
                                );
                            })}
...
export default CiudadesProvincia;