...
const ExplorarProvincias = () => {
    ...
    const irAProvincias = () => {
        ...
        navigate(`/departamentos/${currentDepartamento.id}/provincias`);
    };
        ...
        return (
            <div className="explorar-prov-page">
                ...
                <main className="explorar-prov-state">
                    ...
                    <p>Primero registra departamentos para poder explorar sus provincias.</p>
                ...
                <section className="explorar-prov-content">
                    <div className="explorar-prov-left">
                        ...
                        <div className="explorar-prov-location">
                            <span></span>
                            <p>Explorar provincias por departamento</p>
                        </div>

                        <h1>{currentDepartamento.nombre}</h1>

                        <p className="explorar-prov-description">
                            Selecciona un departamento del Perú para consultar sus provincias,
                            capitales, población, actividades económicas y festividades
                            representativas.
                        </p>
                    ...
                    <div className="explorar-prov-right">
                        <div
                            ...
                            className={`explorar-prov-cards-track ${slideDirection === 'next' ? 'cards-next' : 'cards-prev'
                                }`}
                        >
...
export default ExplorarProvincias;